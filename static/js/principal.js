...
/*
let contenu=document.getElementById('contenu_bb');
console.log(contenu.textContent);
console.log(bbcode_parser(contenu.textContent));
alert('jjjj');
contenu.innerHTML=bbcode_parser(contenu.textContent);
*/
